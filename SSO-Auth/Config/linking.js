const ssoConfigLinking = {
  ...
  loadProviderList: (container, providers, provider_mode) => {
    providers.forEach((provider_name) => {
      ...
      addLink.classList.add("fab", "emby-button", "sso-provider-add-link");
      var addIcon = document.createElement("span");
      addIcon.classList.add("material-icons", "add");
      ...
      provider_config.appendChild(addLink);
      provider_config.appendChild(existingLinksContainer);
  ...
  populateExistingLinks: (
    ...
    const checkboxes = canonical_names.map((canonical_name) => {
      ...
      checkbox.setAttribute("data-id", canonical_name);
      checkbox.setAttribute("data-mode", provider_mode);
      checkbox.setAttribute("data-provider", provider_name);
      checkbox.type = "checkbox";

      var span = document.createElement("span");
      span.classList.add("checkbox-label");
      span.textContent = canonical_name;
