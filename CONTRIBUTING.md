...
- Alternatively, if you use [Nix](https://nixos.org/), run `nix develop` from the repo root to get the correct toolchain.

#### Getting Started

```bash
git clone https://github.com/9p4/jellyfin-plugin-sso.git
cd jellyfin-plugin-sso
dotnet restore SSO-Auth/
dotnet build SSO-Auth/
dotnet test   # runs the automated test suite
```

#### Editors

Any code editor or IDE with .NET support will work:

- [VSCode](https://code.visualstudio.com/docs/languages/dotnet) -- see [strazto/jellyfin-plugin-sso-vscode](https://github.com/strazto/jellyfin-plugin-sso-vscode) for an example `.vscode` configuration
- [N/Vim](https://github.com/OmniSharp/Omnisharp-vim)
- [JetBrains Rider](https://www.jetbrains.com/rider/)

#### Installing From Source

Build with `dotnet publish .` in the `SSO-Auth` directory. Copy the DLLs from `bin/Debug/net9.0/publish` to a new folder in your Jellyfin configuration: `config/plugins/sso`. Restart Jellyfin to load the plugin.

### Improving The Documentation

We are always open to better docs! Areas where documentation can be improved:

- **[providers.md](https://github.com/9p4/jellyfin-plugin-sso/blob/main/providers.md)** -- configurations known to work with common SSO providers. If you've set up a provider not listed there, please add your working configuration.
- **[README.md](https://github.com/9p4/jellyfin-plugin-sso/blob/main/README.md)** -- API endpoint documentation, setup instructions, and examples.
- **Code documentation** -- XML doc comments on public classes and methods in the C# source. These are used by IDEs for autocompletion hints.
...
We use [Prettier](https://prettier.io) to format these files. Run `npx prettier --write .` to format all frontend files before committing.

The GitHub Actions CI pipeline checks formatting on pull requests, so make sure your code passes both `dotnet build` (for C# warnings) and Prettier (for frontend files).
